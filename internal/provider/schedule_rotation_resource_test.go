...
resource "jsm-ops_schedule_rotation" "example" {
  schedule_id = jsm-ops_schedule.example.id
  name       = "` + rotationName + `"
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("jsm-ops_schedule_rotation.example", "participants.0.id", "data.jsm-ops_user.test1", "account_id"),
